...
/datum/admin_help/proc/mentorissue(key_name = key_name_admin(usr))
	...
	msg += "<font color='red'>My issue has been determined by an administrator to be related to ingame mechanics, For further resolution please use mentor help, the wiki, or Discord New Psydonia if nobody is responding to a meditation..</font>"
	if(initiator)
