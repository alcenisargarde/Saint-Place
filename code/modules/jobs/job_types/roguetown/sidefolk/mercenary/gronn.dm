/datum/advclass/mercenary/gronn
	...
	tutorial = "You are one of many upstarts from Gronn, who sailed from the coastal capital of Danheim to the southern beaches of New Psydonia in search of a more... honest means of profit than the Sea Raiders of infamy."
