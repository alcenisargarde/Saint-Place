/datum/job/roguetown/suitor
	...
	tutorial = "You are a noble from a foreign court who has travelled to New Psydonia in order to win the hand of New Psydonia's most eligible bachelor and secure a political ally for your house. Competition is fierce, and it seems you're not the only one vying for the duke's favor..."
