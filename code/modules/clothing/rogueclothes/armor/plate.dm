...
/obj/item/clothing/suit/roguetown/armor/plate/scale/marshal
	...
	desc = "A coat of plates concealed beneath a heavy leather surcoat. Only the most battle-hardened of New Psydonia's commanders can hope to bear its burden, both metaphorically and quite literally."
