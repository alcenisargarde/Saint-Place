...
/obj/item/clothing/head/roguetown/crown/serpcrown/proc/anti_stall()
	src.visible_message(span_danger("The Crown of New Psydonia crumbles to dust, the ashes spiriting away in the direction of the Keep."))
	SSroguemachine.scomm_machines -= src
