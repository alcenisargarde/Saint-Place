...
/obj/item/clothing/head/roguetown/helmet/heavy/guard/bogman
	...
	desc = "A helmet featuring the face of a snarling goblin. Once worn by the Bogmen, now a relic of old New Psydonia."
...
/obj/item/clothing/head/roguetown/helmet/heavy/frogmouth
	...
	desc = "A tall and imposing frogmouth-style helm popular in the highest plateaus of the New Psydonia. It covers not only the entire head and face, but the neck as well. Add a cloth to show the colors of your family or allegiance."
...
/obj/item/clothing/head/roguetown/helmet/heavy/frogmouth/legacy //Triumph-exclusive.
	...
	desc = "A triumphant greathelm, crested with a steel gorget that - while cumbersome - offers the finest protection in all of New Psydonia. Will you succumb to despair, or will you fight for your happiness?"
	smelt_bar_num = 1
