...
#define TRAIT_CLERGY "Clergy of the New Psydonian Church"
...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_GUARDSMAN = span_info("I am vigilant in my duties. In the town of New Psydonia, my abilities are sharper due to my routine and familiarity."),
	...
	TRAIT_WOODSMAN = span_info("I am vigilant in my duties. In the grove and coast of New Psydonia, my abilities are sharper due to my routine and familiarity."),
	...
	TRAIT_CLERGY = span_info("I serve the Church of the Ten in New Psydonia. From a passing glance, I can recognize all other clergy of this Church."),
	...
	TRAIT_RESIDENT = span_info("I've been granted a Meister account, and the ownership of a house in New Psydonia."),
	...
	TRAIT_BLACKOAK = span_warning("The Black Oaks can spot <b>any</b> foreigners and outsiders, no matter how long they've lived in New Psydonia. I can spot an invader at a glance."),
