...
/obj/item/rogueweapon/huntingknife/idagger/silver/elvish/poopknife
	...
	desc = "A heraldric accompaniment to the chamberpot, and the most closely-guarded secret in all of New Psydonia. It is said that this once belonged to the Duke's eldest ancestor, who - in a fit of constipatory labor - had unwittingly realized another use for their wave-bladed trophy. Clinging to its silvered edge is a thin layer of otherworldly ash, refusing to yield to neither soap-nor-rag."
